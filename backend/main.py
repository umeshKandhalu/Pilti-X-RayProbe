...
from inference import XRayAnalyzer
...
# Initialize modules (load model once)
...
async def list_reports(email: str):
            ...
            if key.endswith(".pdf"):
                ...
                if len(parts) >= 3:
                    ...
                    try:
                        ...
                        print(f"DEBUG Parsing: File={file_name}, ID={patient_id}, NamePart={name_part}") # DEBUG LOG
...
@app.get("/reports/{email}/{patient_id}/pdf")
async def get_report_pdf(email: str, patient_id: str):
